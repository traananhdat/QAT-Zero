...
def draw_text(
    ...
    display_str_heights = [
        font.getbbox(ds)[2] - font.getbbox(ds)[0] for ds in display_str
    ]
    ...
    for ds in display_str:
        text_width, text_height = (
            font.getbbox(ds)[2] - font.getbbox(ds)[0],
            font.getbbox(ds)[3] - font.getbbox(ds)[1],
        )
...
def draw_objs(
    ...
    colors = [
        ImageColor.getrgb(STANDARD_COLORS[cls % len(STANDARD_COLORS)])
        for cls in classes
    ]
