...
def asymmetric_linear_quantization_params(num_bits, min_val, max_val):
    """
...
class SymmetricQuantFunction(Function):
    ...
    def forward(ctx, x, k, x_min=None, x_max=None):
        ...
        x_max=None
        """
        scale, zero_point, qmin, qmax = symmetric_linear_quantization_params(
            k, x_min, x_max
        )
...
class AsymmetricQuantFunction(Function):
    ...
    def forward(ctx, x, k, x_min=None, x_max=None):
        ...
        x_max=None
        """
        scale, zero_point, qmin, qmax = asymmetric_linear_quantization_params(
            k, x_min, x_max
        )
